...
## 3. Typography
We use a classic pairing of a serif headline font with a clean sans-serif body font. This creates a look that is both established and modern.

### Primary Typeface (Headlines)
*   **Font:** **Libre Baskerville**
*   **Usage:** Headlines, key statements, "Call to Action" links.
*   **Characteristics:** Traditional, editorial, authoritative.
*   **Weights:** Regular (400), Bold (700), Italic.

### Secondary Typeface (Body & UI)
*   **Font:** **Inter**
*   **Usage:** Body paragraphs, navigation, UI elements, labels.
...
### Primary Colors
*   **Charcoal (Text/UI):** `#1a1a1a`
    *   Used for all primary text and headings. Softer than pure black for better readability.
*   **Paper (Background):** `#FAFAF8`
    *   A warm, off-white cream color. Provides a tactile, organic feel compared to sterile white.

### Secondary & Accent Colors
*   **Growth Green:** `#4ADE80`
    *   Used sparingly for "active" indicators (e.g., the pulsing dot in the navigation) or to highlight success metrics.
*   **Divider Grey:** `#e5e5e5`
    *   Used for subtle borders and dividers.
*   **Text Grey:** `#404040` / `#737373`
    *   Used for subheadlines, body text, and labels.

## 5. Visual Effects & Texture
*   **Grain Overlay:** A subtle SVG noise filter (`opacity: 0.04`) is applied over the entire site. This gives the digital interface a "physical" texture, reinforcing the "felt not seen" aesthetic.
*   **Focus/Blur:** We use a `blur` effect triggered by scroll position to direct user attention. Elements fade in and out of focus, mimicking the behavior of a camera lens.
*   **Motion:** Animations are smooth and physics-based (using `lenis` for scrolling). Transitions are deliberate, reinforcing a sense of weight and quality.
...
*   **Short Name:** SSP (Internal use only, avoid in public copy if possible)
