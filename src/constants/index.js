...
export const PARTNER_OUTCOMES = [
  {
    ...
    detail:
      'Luxury beauty retailer breaks growth plateau after strategy, media, and operations transformation.',
...
export const TIERS = [
  ...
  },
  {
    ...
    description:
      "For founders who need an executive thought partner. We help you make the right decisions on hiring, vendors, and positioning. With honest guidance on what's working and what isn't.",
  },
];
    ...
    features: [
      {
        ...
        description:
          'Strategy calls to review progress, troubleshoot issues, and align on priorities.',
        advisory: true,
        strategy: true,
        management: true,
      },
    ...
    features: [
      {
        ...
        description:
          'Positioning, channel selection, and GTM audit to identify gaps and opportunities.',
        advisory: false,
        strategy: true,
        management: true,
      },
...
export const MOBILE_TIERS = [
  ...
  },
  {
    ...
    features: ['Strategic Coaching', 'Vendor Guidance', 'Tool Recommendations'],
  },
];
