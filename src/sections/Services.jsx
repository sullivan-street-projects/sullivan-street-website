      ...
      <div className="border-t border-[#e5e5e5]">
        <div className="py-20">
          ...
          <div className="lg:hidden">
            {COMPARISON_DATA.map((section) => (
              <div key={section.category} className="mb-20 last:mb-0">
                ...
                <div className="overflow-x-auto -mx-6 px-6 pb-4 pt-4 snap-x snap-mandatory scroll-smooth scroll-pl-[180px]">
                  <div className="min-w-[650px]">
                    
                    {/* Mobile Column Header */}
                    <div className="flex border-b border-[#d4d4d4] pb-4 mb-0 pt-4">
                       <div className="w-[180px] flex-none sticky left-0 z-30 bg-[#FAFAF8] pr-4 border-r border-[#d4d4d4] flex items-end">
                    ...
                    <div className="space-y-0">
                      {section.features.map((feature) => (
                        <div key={feature.name} className="flex py-6 border-b border-[#d4d4d4] items-start group hover:bg-[#fafafa] transition-colors duration-300">
                          <div className="w-[180px] flex-none sticky left-0 z-20 bg-[#FAFAF8] pr-4 border-r border-[#d4d4d4] group-hover:bg-[#fafafa]">
                            <FocusText>
          ...
          <div className="hidden lg:block">
            ...
            <div className="grid grid-cols-[40%_1fr_1fr_1fr] border-b border-[#d4d4d4] pb-6 mb-8 gap-4">
