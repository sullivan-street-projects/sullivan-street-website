          ...
          <div className="lg:hidden">
            {COMPARISON_DATA.map((section) => (
              <div key={section.category} className="mb-12 last:mb-0">
                ...
                <div className="overflow-x-auto -mx-6 lg:mx-0 lg:px-0 pb-4 pt-4 snap-x snap-mandatory scroll-smooth scroll-pl-[200px]">
                  <div className="min-w-[650px]">
                    
                    {/* Mobile Section Header - Merged Category Name */}
                    <div className="flex border-b border-[#1a1a1a] pb-4 mb-0 pt-4">
                       <div className="w-[200px] pl-6 flex-none sticky left-0 z-30 bg-[#FAFAF8] pr-4 flex items-end">
                         <FocusText>
