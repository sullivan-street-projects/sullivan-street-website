...
// Icon-sized versions of finalized halftone patterns (w-8 h-8)
...
const ValuePropsEditorialHalftone = () => {
  return (
    <div>
      <p className="font-sans text-sm font-medium text-[#737373] mb-6">
        N: EDITORIAL + HALFTONE — Structured grid with halftone accents, no cards
      </p>
      ...
      <p className="font-sans text-[12px] text-[#a3a3a3] mt-6 italic">
        M's editorial grid + K's halftone icons. No numbers, no cards.
      </p>
    </div>
  );
};

export default ValuePropsEditorialHalftone;
