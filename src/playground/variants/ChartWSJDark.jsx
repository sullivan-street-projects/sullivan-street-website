...
export default function ChartWSJDark() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full max-w-[960px] mx-auto px-6 py-16 md:py-24 rounded-lg"
      style={{ backgroundColor: CHARCOAL }}
    >
      {/* Headline — bold serif "$2B+" */}
      <div className="mb-2">
        <h2
          className="text-[80px] md:text-[100px] leading-[0.85] tracking-tight"
          style={{ fontFamily: SERIF, fontWeight: 700, color: PAPER }}
        >
          $2B+
        </h2>
      </div>
      <p
        className="text-[13px] md:text-[14px] mb-10 md:mb-14 max-w-md"
        style={{ fontFamily: SANS, color: LABEL_MUTED }}
      >
      ...
      <div className="relative">
        ...
        >
          <defs>
            <linearGradient id="wsjDarkAreaGrad" x1="0" y1="0" x2="0" y2="1">
      ...
      {/* Typewriter caption */}
      <div className="mt-6 pt-4 min-h-[2rem]" style={{ borderTop: `1px solid ${GRID}` }}>
        {reducedMotion ? (
          <p
          ...
          <p
            className="text-[13px] italic relative"
            style={{ fontFamily: SANS, color: LABEL_MUTED }}
          >
            ...
            <span className="absolute top-0 left-0 w-full">
              ...
              {typeActive && typeIndex < TYPEWRITER_TEXT.length && (
                <motion.span
                  ...
                  className="inline-block w-[2px] h-[0.85em] ml-0.5 translate-y-[0.12em]"
      ...
      <p
        ...
        style={{ fontFamily: SANS, color: SOURCE }}
      >
